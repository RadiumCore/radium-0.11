...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("52.23.134.122", "52.23.134.122"));
        vSeeds.push_back(CDNSSeedData("35.153.123.156", "35.153.123.156"));
        vSeeds.push_back(CDNSSeedData("34.207.38.233", "34.207.38.233"));
